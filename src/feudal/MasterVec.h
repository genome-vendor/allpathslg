...
public:
    ...
    { BaseT::push_back(val); return *this; }

    /// This function is deprecated:  Use push_back().
    MasterVec& push_back_reserve( T const& val,
                                  size_type growthIncr = 0,
                                  float growthFact = 1.3f )
    { BaseT::push_back(val,growthFact,growthIncr); return *this; }
    ...
    { BaseT::append(that.begin(from),that.begin(to)); return *this; }
