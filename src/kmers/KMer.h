...
public:
    ...
    CanonicalForm::Value getCanonicalForm() const
    { return CanonicalForm::getForm<iterator,K>(begin()); }

    bool isRev() const
    { return CanonicalForm::isRev<iterator,K>(begin()); }

    bool isPalindrome() const
    { return CanonicalForm::isPalindrome<iterator,K>(begin()); }
        ...
        { beg = mVal;
          ...
          { storage_type cur = *end;
            *end = (cur << UNUSED_TRAILING_BITS) | prev;
            prev = cur >> (BITS_PER_STORAGE_UNIT - UNUSED_TRAILING_BITS); } } }
      return *this; }

    unsigned long hash() const
    { unsigned long result = 14695981039346656037ul;
      unsigned char const* itr =
                             reinterpret_cast<unsigned char const*>(mVal);
