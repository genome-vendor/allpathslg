...
template digraphE<KmerPath>::digraphE(const vec<vec<int> >&, const vec<vec<int> >&, const vec<KmerPath>&, const vec<vec<int> >&, const vec<vec<int> >&);
template void digraphE<KmerPath>::AddEdge(int, int, KmerPath const&);
...
template Bool digraphE<KmerPath>::EdgePaths(int, int, vec<vec<int> >&, const int, const int, const int);
...
template void digraphE<KmerPath>::Initialize(vec<vec<int> > const&, vec<vec<int> > const&, vec<KmerPath> const&, vec<vec<int> > const&, vec<vec<int> > const&);
...
template void digraphE<KmerPath>::TestValid() const;
