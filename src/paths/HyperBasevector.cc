...
template void digraphE<BaseVec>::TestValid( ) const;
template digraphE<BaseVec>::digraphE();
template digraphE<BaseVec>::digraphE(vec<BaseVec> const&, const ConstructorBehavior);
template digraphE<BaseVec>::digraphE(const vec<vec<int> >&, const vec<vec<int> >&, const vec<BaseVec>&, const vec<vec<int> >&, const vec<vec<int> >&);
...
template void digraphE<BaseVec>::Initialize(vec<vec<int> > const&, vec<vec<int> > const&, vec<BaseVec> const&, vec<vec<int> > const&, vec<vec<int> > const&);
...
template void digraphE<BaseVec>::RemoveDeadEdgeObjects();
