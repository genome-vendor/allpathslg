...
int load_contamination_list( String in_contam_file, contam_vec& v_contam, const vec<efasta>& efastas, Bool& is_zero_based){
		     ...
		     String out_save_contam_file)
{
  ...
  Assembly assembly_new( scaffolds, efastas, &scaffMap, &tigMap, &SG );
