...
template digraphE<gapster>::digraphE(const vec<vec<int> >&, const vec<vec<int> >&, const vec<gapster>&, const vec<vec<int> >&, const vec<vec<int> >&);
template void digraphE<gapster>::AddEdge(const int, const int, const gapster&);
...
template void digraphE<gapster>::Initialize(vec<vec<int> > const&, vec<vec<int> > const&, vec<gapster> const&, vec<vec<int> > const&, vec<vec<int> > const&);
...
template void digraphE<gapster>::RemoveDeadEdgeObjects();
...
template void digraphE<sepdevkind>::Initialize(const vec<vec<int> >&, const vec<vec<int> >&, const vec<sepdevkind>&, const vec<vec<int> >&, const vec<vec<int> >&);
