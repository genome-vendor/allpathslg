...
template void digraphE<CLinkBundle>::Initialize(const vec< vec<int> >&, const vec< vec<int> >&, const vec<CLinkBundle>&, const vec< vec<int> >&, const vec< vec<int> >&);
...
template void digraphE<CLinkBundle>::RemoveDeadEdgeObjects();
