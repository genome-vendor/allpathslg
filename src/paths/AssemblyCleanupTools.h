...
class Assembly{
 ...
 public:
  ...
  Assembly( const vec<superb>& scaffolds, const vec<efasta>& efastas, const vec<String>* scaffMap = 0, const vec<String>* tigMap = 0, const digraphE<sepdev>* SG = 0 );
  ...
  const vec<efasta>& efastas() const { return efastas_; }
