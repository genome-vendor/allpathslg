...
template void digraphE<sepdev>::Initialize(const vec<vec<int> >&, const vec<vec<int> >&, const vec<sepdev>&, const vec<vec<int> >&, const vec<vec<int> >& );
...
template void digraphE<fsepdev>::AddEdge(const int, const int, const fsepdev&);
...
template Bool digraphE<Tsepdev<double> >::EdgePaths(const int, const int, vec<vec<int> >&, const int, const int, const int);
...
template void digraphE<Tsepdev<double> >::Initialize(const vec<vec<int> >&, const vec<vec<int> >&, const vec<Tsepdev<double> >&, const vec<vec<int> >&, const vec<vec<int> >&);
...
template void digraphE<Tsepdev<int> >::AddEdge(const int, const int, const Tsepdev<int>&);
...
template void digraphE<Tsepdev<int> >::RemoveDeadEdgeObjects();
